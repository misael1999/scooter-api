...
class OrderCurrentStatusSerializer(serializers.ModelSerializer):
    ...
    order_status_obj = OrderStatusModelSerializer(read_only=True, source="order_status")
...
class OrderModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "delivery_man", "station", "service", "service_obj", "distance",
                  ...
                  'is_order_to_merchant', 'date_update_order', 'is_payment_online')
...
class OrderWithDetailSimpleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "service",
                  ...
                  'order_price', 'total_order', 'is_delivery_by_store', 'is_payment_online'
...
class OrderWithDetailModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id",'merchant', "service",
                  ...
                  'order_price', 'total_order', 'is_delivery_by_store', 'is_order_to_merchant', 'date_update_order', 'is_payment_online'
                  )
        read_only_fields = fields
